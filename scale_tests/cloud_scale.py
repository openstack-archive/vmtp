...
class CloudScale(object):
    ...
    def runner(self):
        """
        The runner for cloud scale Tests
...
if __name__ == '__main__':
    ...
    # The Cloud scale class is just a wrapper class
